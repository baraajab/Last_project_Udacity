...
const fetchLocationDetails = async (city) => {
  try {
    ...
    // Check if geonames array exists and has elements
    ...
    locationData.lat = "34.0522";  // Los Angeles coordinates
...
const fetchCityImage = async (city) => {
  ...
  try {
    ...
    if (!data.hits || data.hits.length === 0) {
      ...
      // Try with a more generic term like "city" or "travel"
    }
    ...
    // Set default image for testing
    tripData.imageUrl = "https://pixabay.com/get/g4f7c3af632abb03b99fa58e4ce0e3e88cec9dc4acf548c1af4a92c98e26aa83f66a598e00e0e8e3d9267efcae48c9cf0_640.jpg";
